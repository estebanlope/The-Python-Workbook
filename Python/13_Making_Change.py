...
CENTS_PER_DIME = 10
CENTS_PER_NICKEL = 5
COINS = [CENTS_PER_TOONIE, CENTS_PER_LOONIE, CENTS_PER_QUARTER, CENTS_PER_DIME, CENTS_PER_NICKEL]
COINSNAME = ['toonie', 'loonie', 'quarter', 'dime', 'nickel']

# Read the input from the user
numCents = int(input('Enter the number of cents: '))

# Calculate and display the results
for coin, coinName in zip(COINS, COINSNAME):
  print('->', numCents // coin, coinName)
  numCents %= coin
else:
  print('->', numCents, 'pennies')